    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative">
                {user?.profilePicture ? (
                  ...
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-indigo-500 to-violet-500 flex items-center justify-center text-white text-sm font-bold border-2 border-indigo-100 ring-2 ring-white">
                    {userInitials}
                  </div>
                )}
      ...
      <div className="flex">
        ...
        <aside className="w-64 bg-white border-r border-slate-200 min-h-[calc(100vh-73px)] p-6">
          ...
          {/* Setup Profile CTA */}
          {user && (
            <div className="mt-8 p-4 bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200 rounded-lg">
