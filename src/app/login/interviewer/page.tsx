        ...
        <div className="theme-surface-card bg-white rounded-2xl shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-200 dark:border-white/10 p-8">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white dark:bg-slate-900 text-slate-500 dark:text-slate-400">Or sign in with email</span>
            </div>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-slate-600 dark:text-slate-400">
              ...
              <Link href="/signup/interviewer" className="text-indigo-600 dark:text-indigo-300 hover:text-indigo-700 dark:hover:text-indigo-200 font-medium">
                Sign up
              </Link>
            </p>
          </div>
