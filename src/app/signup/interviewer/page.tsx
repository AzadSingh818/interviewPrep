...
export default function InterviewerSignupPage() {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      // ✅ Set the role cookie BEFORE Google OAuth starts
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-violet-50 dark:from-[#09111f] dark:via-slate-950 dark:to-[#101936] flex items-center justify-center p-6">
        ...
        <div className="theme-surface-card bg-white rounded-2xl shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-200 dark:border-white/10 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-400/20 rounded-xl p-3 text-sm text-blue-700 dark:text-blue-300">
              <div className="flex gap-2">
                ...
                <p>You'll receive a verification code via email to complete your registration.</p>
              </div>
            </div>

            <div className="bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-400/20 rounded-xl p-3 text-sm text-amber-800 dark:text-amber-300">
          ...
          <div className="mt-6 text-center">
            <p className="text-slate-600 dark:text-slate-400">
              ...
              <Link href="/login/interviewer" className="text-indigo-600 dark:text-indigo-300 hover:text-indigo-700 dark:hover:text-indigo-200 font-medium">
                Sign in
              </Link>
            </p>
          </div>
